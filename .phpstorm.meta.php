...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/my-core-pustu/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/my-core-pustu/public/storage','logging.default',
...
'livewire.preview-file','dashboard-lala.index','dashboard.index','dashboard.index','profile.edit','profile.update',
'profile.destroy','dashboard.create','register.create','register.store','tables.store',
'tables.edit','tables.update','tables.delete','users.data',
'ibu.index','ibu.create','ibu.store','ibu.edit','ibu.update',
'ibu.delete','ibu2.index','ibu2.create','ibu2.store','ibu2.edit',
'ibu2.update','ibu2.delete','keluarga.index','keluarga.create','keluarga.store',
'keluarga.edit','keluarga.update','keluarga.delete','kesehatan1.index','kesehatan1.create',
'kesehatan1.store','kesehatan1.edit','kesehatan1.update','kesehatan1.delete','kesehatan2.index',
'kesehatan2.create','kesehatan2.store','kesehatan2.edit','kesehatan2.update','kesehatan2.delete',
'kesehatan-bersalin.index','kesehatan-bersalin.create','kesehatan-bersalin.store','kesehatan-bersalin.edit','kesehatan-bersalin.update',
'kesehatan-bersalin.delete','kesehatan-nifas.index','kesehatan-nifas.create','kesehatan-nifas.store','kesehatan-nifas.edit',
'kesehatan-nifas.update','kesehatan-nifas.delete','kontrol-ttd.index','kontrol-ttd.create','kontrol-ttd.store',
'kontrol-ttd.edit','kontrol-ttd.update','kontrol-ttd.delete','minum-ttd.index','minum-ttd.create',
'minum-ttd.store','minum-ttd.edit','minum-ttd.update','minum-ttd.delete','menyambut-persalinan.index',
'menyambut-persalinan.create','menyambut-persalinan.store','menyambut-persalinan.edit','menyambut-persalinan.update','menyambut-persalinan.delete',
'amanat-penolong-persalinan.index','amanat-penolong-persalinan.create','amanat-penolong-persalinan.store','amanat-penolong-persalinan.edit','amanat-penolong-persalinan.update',
'amanat-penolong-persalinan.delete','amanat-kendaraan.index','amanat-kendaraan.create','amanat-kendaraan.store','amanat-kendaraan.edit',
'amanat-kendaraan.update','amanat-kendaraan.delete','amanat-darah.index','amanat-darah.create','amanat-darah.store',
'amanat-darah.edit','amanat-darah.update','amanat-darah.delete','evaluasi-kesehatan-bumil.index','evaluasi-kesehatan-bumil.create',
'evaluasi-kesehatan-bumil.store','evaluasi-kesehatan-bumil.edit','evaluasi-kesehatan-bumil.update','evaluasi-kesehatan-bumil.delete','kondisi-kesehatan-bumil.index',
'kondisi-kesehatan-bumil.create','kondisi-kesehatan-bumil.store','kondisi-kesehatan-bumil.edit','kondisi-kesehatan-bumil.update','kondisi-kesehatan-bumil.delete',
'imunisasi-t.index','imunisasi-t.create','imunisasi-t.store','imunisasi-t.edit','imunisasi-t.update',
'imunisasi-t.delete','riwayat-kesehatan-bumil.index','riwayat-kesehatan-bumil.create','riwayat-kesehatan-bumil.store','riwayat-kesehatan-bumil.edit',
'riwayat-kesehatan-bumil.update','riwayat-kesehatan-bumil.delete','riwayat-perilaku-berisiko.index','riwayat-perilaku-berisiko.create','riwayat-perilaku-berisiko.store',
'riwayat-perilaku-berisiko.edit','riwayat-perilaku-berisiko.update','riwayat-perilaku-berisiko.delete','riwayat-kehamilan.index','riwayat-kehamilan.create',
'riwayat-kehamilan.store','riwayat-kehamilan.edit','riwayat-kehamilan.update','riwayat-kehamilan.delete','riwayat-penyakit-keluarga.index',
'riwayat-penyakit-keluarga.create','riwayat-penyakit-keluarga.store','riwayat-penyakit-keluarga.edit','riwayat-penyakit-keluarga.update','riwayat-penyakit-keluarga.delete',
'pemeriksaan-khusus.index','pemeriksaan-khusus.create','pemeriksaan-khusus.store','pemeriksaan-khusus.edit','pemeriksaan-khusus.update',
'pemeriksaan-khusus.delete','pemeriksaan-trimester1.index','pemeriksaan-trimester1.create','pemeriksaan-trimester1.store','pemeriksaan-trimester1.edit',
'pemeriksaan-trimester1.update','pemeriksaan-trimester1.delete','pemeriksaan-fisik-tri1.index','pemeriksaan-fisik-tri1.create','pemeriksaan-fisik-tri1.store',
'pemeriksaan-fisik-tri1.edit','pemeriksaan-fisik-tri1.update','pemeriksaan-fisik-tri1.delete','usg-tri1.index','usg-tri1.create',
'usg-tri1.store','usg-tri1.edit','usg-tri1.update','usg-tri1.delete','pemeriksaan-laboratorium-tri1.index',
'pemeriksaan-laboratorium-tri1.create','pemeriksaan-laboratorium-tri1.store','pemeriksaan-laboratorium-tri1.edit','pemeriksaan-laboratorium-tri1.update','pemeriksaan-laboratorium-tri1.delete',
'evaluasi-kehamilan.index','evaluasi-kehamilan.create','evaluasi-kehamilan.store','evaluasi-kehamilan.edit','evaluasi-kehamilan.update',
'evaluasi-kehamilan.delete','berat-badan-bumil.index','berat-badan-bumil.create','berat-badan-bumil.store','berat-badan-bumil.edit',
'berat-badan-bumil.update','berat-badan-bumil.delete','skrining-preeklampsia.index','skrining-preeklampsia.create','skrining-preeklampsia.store',
'skrining-preeklampsia.edit','skrining-preeklampsia.update','skrining-preeklampsia.delete','preeklampsia-anamnesis.index','preeklampsia-anamnesis.create',
'preeklampsia-anamnesis.store','preeklampsia-anamnesis.edit','preeklampsia-anamnesis.update','preeklampsia-anamnesis.delete','preeklampsia-fisik.index',
'preeklampsia-fisik.create','preeklampsia-fisik.store','preeklampsia-fisik.edit','preeklampsia-fisik.update','preeklampsia-fisik.delete',
'pemeriksaan-trimester3.index','pemeriksaan-trimester3.create','pemeriksaan-trimester3.store','pemeriksaan-trimester3.edit','pemeriksaan-trimester3.update',
'pemeriksaan-trimester3.delete','pemeriksaan-fisik-tri3.index','pemeriksaan-fisik-tri3.create','pemeriksaan-fisik-tri3.store','pemeriksaan-fisik-tri3.edit',
'pemeriksaan-fisik-tri3.update','pemeriksaan-fisik-tri3.delete','usg-tri3.index','usg-tri3.create','usg-tri3.store',
'usg-tri3.edit','usg-tri3.update','usg-tri3.delete','pemeriksaan-laboratorium-tri3.index','pemeriksaan-laboratorium-tri3.create',
'pemeriksaan-laboratorium-tri3.store','pemeriksaan-laboratorium-tri3.edit','pemeriksaan-laboratorium-tri3.update','pemeriksaan-laboratorium-tri3.delete','ringkasan-kesehatan.index',
'ringkasan-kesehatan.create','ringkasan-kesehatan.store','ringkasan-kesehatan.edit','ringkasan-kesehatan.update','ringkasan-kesehatan.delete',
'ibu-bersalin.index','ibu-bersalin.create','ibu-bersalin.store','ibu-bersalin.edit','ibu-bersalin.update',
'ibu-bersalin.delete','bayi-lahir.index','bayi-lahir.create','bayi-lahir.store','bayi-lahir.edit',
'bayi-lahir.update','bayi-lahir.delete','ringkasan-nifas.index','ringkasan-nifas.create','ringkasan-nifas.store',
'ringkasan-nifas.edit','ringkasan-nifas.update','ringkasan-nifas.delete','ringkasan-kesimpulan-nifas.index','ringkasan-kesimpulan-nifas.create',
'ringkasan-kesimpulan-nifas.store','ringkasan-kesimpulan-nifas.edit','ringkasan-kesimpulan-nifas.update','ringkasan-kesimpulan-nifas.delete','rujukan.index',
'rujukan.create','rujukan.store','rujukan.edit','rujukan.update','rujukan.delete',
'wali.index','wali.create','wali.store','wali.edit','wali.update',
'wali.delete','anak.index','anak.create','anak.store','anak.edit',
'anak.update','anak.delete','identitas.anak.store','identitas.anak.edit','identitas.anak.update',
'identitas.anak.delete','identitas.anak.data','bayi-baru-lahir.index','bayi-baru-lahir.create','bayi-baru-lahir.store',
'bayi-baru-lahir.edit','bayi-baru-lahir.update','bayi-baru-lahir.delete','bayi.index','bayi.create',
'bayi.store','bayi.edit','bayi.update','bayi.delete','anak-balita.index',
'anak-balita.create','anak-balita.store','anak-balita.edit','anak-balita.update','anak-balita.delete',
'keterangan-lahir.index','keterangan-lahir.create','keterangan-lahir.store','keterangan-lahir.edit','keterangan-lahir.update',
'keterangan-lahir.delete','riwayat-kelahiran.index','riwayat-kelahiran.create','riwayat-kelahiran.store','riwayat-kelahiran.edit',
'riwayat-kelahiran.update','riwayat-kelahiran.delete','pelayanan-kesehatan-neonatus.index','pelayanan-kesehatan-neonatus.create','pelayanan-kesehatan-neonatus.store',
'pelayanan-kesehatan-neonatus.edit','pelayanan-kesehatan-neonatus.update','pelayanan-kesehatan-neonatus.delete','kn0.index','kn0.create',
'kn0.store','kn0.edit','kn0.update','kn0.delete','kn1.index',
'kn1.create','kn1.store','kn1.edit','kn1.update','kn1.delete',
'kn2.index','kn2.create','kn2.store','kn2.edit','kn2.update',
'kn2.delete','kn3.index','kn3.create','kn3.store','kn3.edit',
'kn3.update','kn3.delete','imunisasi.index','imunisasi.create','imunisasi.store',
'imunisasi.edit','imunisasi.update','imunisasi.delete','pemantauan-kia.index','pemantauan-kia.create',
'pemantauan-kia.store','pemantauan-kia.edit','pemantauan-kia.update','pemantauan-kia.delete','pelayanan-sdidtk.index',
'pelayanan-sdidtk.create','pelayanan-sdidtk.store','pelayanan-sdidtk.edit','pelayanan-sdidtk.update','pelayanan-sdidtk.delete',
'penyimpangan-pertumbuhan.index','penyimpangan-pertumbuhan.create','penyimpangan-pertumbuhan.store','penyimpangan-pertumbuhan.edit','penyimpangan-pertumbuhan.update',
'penyimpangan-pertumbuhan.delete','penyimpangan-perkembangan.index','penyimpangan-perkembangan.create','penyimpangan-perkembangan.store','penyimpangan-perkembangan.edit',
'penyimpangan-perkembangan.update','penyimpangan-perkembangan.delete','penyimpangan-emosional.index','penyimpangan-emosional.create','penyimpangan-emosional.store',
'penyimpangan-emosional.edit','penyimpangan-emosional.update','penyimpangan-emosional.delete','nasihat-anak.index','nasihat-anak.create',
'nasihat-anak.store','nasihat-anak.edit','nasihat-anak.update','nasihat-anak.delete','kapsul-anak.index',
'kapsul-anak.create','kapsul-anak.store','kapsul-anak.edit','kapsul-anak.update','kapsul-anak.delete',
'kms-perempuan.index','kms-perempuan.create','kms-perempuan.store','kms-perempuan.edit','kms-perempuan.update',
'kms-perempuan.delete','data-kms-perempuan.index','data-kms-perempuan.create','data-kms-perempuan.store','data-kms-perempuan.edit',
'data-kms-perempuan.update','data-kms-perempuan.delete','bb-u-perempuan.index','bb-u-perempuan.create','bb-u-perempuan.store',
'bb-u-perempuan.edit','bb-u-perempuan.update','bb-u-perempuan.delete','tb-u-perempuan.index','tb-u-perempuan.create',
'tb-u-perempuan.store','tb-u-perempuan.edit','tb-u-perempuan.update','tb-u-perempuan.delete','bb-tb-perempuan.index',
'bb-tb-perempuan.create','bb-tb-perempuan.store','bb-tb-perempuan.edit','bb-tb-perempuan.update','bb-tb-perempuan.delete',
'lingkar-kepala-perempuan.index','lingkar-kepala-perempuan.create','lingkar-kepala-perempuan.store','lingkar-kepala-perempuan.edit','lingkar-kepala-perempuan.update',
'lingkar-kepala-perempuan.delete','kms-laki.index','kms-laki.create','kms-laki.store','kms-laki.edit',
'kms-laki.update','kms-laki.delete','data-kms-laki.index','data-kms-laki.create','data-kms-laki.store',
'data-kms-laki.edit','data-kms-laki.update','data-kms-laki.delete','bb-u-laki.index','bb-u-laki.create',
'bb-u-laki.store','bb-u-laki.edit','bb-u-laki.update','bb-u-laki.delete','tb-u-laki.index',
'tb-u-laki.create','tb-u-laki.store','tb-u-laki.edit','tb-u-laki.update','tb-u-laki.delete',
'bb-tb-laki.index','bb-tb-laki.create','bb-tb-laki.store','bb-tb-laki.edit','bb-tb-laki.update',
'bb-tb-laki.delete','lingkar-kepala-laki.index','lingkar-kepala-laki.create','lingkar-kepala-laki.store','lingkar-kepala-laki.edit',
'lingkar-kepala-laki.update','lingkar-kepala-laki.delete','imt-perempuan.index','imt-perempuan.create','imt-perempuan.store',
'imt-perempuan.edit','imt-perempuan.update','imt-perempuan.delete','imt-laki.index','imt-laki.create',
'imt-laki.store','imt-laki.edit','imt-laki.update','imt-laki.delete','kesehatan-gigi.index',
'kesehatan-gigi.create','kesehatan-gigi.store','kesehatan-gigi.edit','kesehatan-gigi.update','kesehatan-gigi.delete',
'data-kesehatan-gigi.index','data-kesehatan-gigi.create','data-kesehatan-gigi.store','data-kesehatan-gigi.edit','data-kesehatan-gigi.update',
'data-kesehatan-gigi.delete','ringkasan-mtbs.index','ringkasan-mtbs.create','ringkasan-mtbs.store','ringkasan-mtbs.edit',
'ringkasan-mtbs.update','ringkasan-mtbs.delete','ringkasan-pelayanan-dokter.index','ringkasan-pelayanan-dokter.create','ringkasan-pelayanan-dokter.store',
'ringkasan-pelayanan-dokter.edit','ringkasan-pelayanan-dokter.update','ringkasan-pelayanan-dokter.delete','rujukan-anak.index','rujukan-anak.create',
'rujukan-anak.store','rujukan-anak.edit','rujukan-anak.update','rujukan-anak.delete','grafik-bb-u-lk.index',
'grafik-bb-u-lk.create','grafik-bb-u-lk.store','grafik-bb-u-lk.edit','grafik-bb-u-lk.update','grafik-bb-u-lk.delete',
'grafik-bb-u-lk.data','grafik-tb-u-lk.index','grafik-tb-u-lk.create','grafik-tb-u-lk.store','grafik-tb-u-lk.edit',
'grafik-tb-u-lk.update','grafik-tb-u-lk.delete','grafik-tb-u-lk.data','grafik-bb-tb-lk.index','grafik-bb-tb-lk.create',
'grafik-bb-tb-lk.store','grafik-bb-tb-lk.edit','grafik-bb-tb-lk.update','grafik-bb-tb-lk.delete','grafik-bb-tb-lk.data',
'grafik-lingkar-lk.index','grafik-lingkar-lk.create','grafik-lingkar-lk.store','grafik-lingkar-lk.edit','grafik-lingkar-lk.update',
'grafik-lingkar-lk.delete','grafik-lingkar-lk.data','grafik-bb-u-pr.index','grafik-bb-u-pr.create','grafik-bb-u-pr.store',
'grafik-bb-u-pr.edit','grafik-bb-u-pr.update','grafik-bb-u-pr.delete','grafik-bb-u-pr.data','grafik-tb-u-pr.index',
'grafik-tb-u-pr.create','grafik-tb-u-pr.store','grafik-tb-u-pr.edit','grafik-tb-u-pr.update','grafik-tb-u-pr.delete',
'grafik-tb-u-pr.data','grafik-bb-tb-pr.index','grafik-bb-tb-pr.create','grafik-bb-tb-pr.store','grafik-bb-tb-pr.edit',
'grafik-bb-tb-pr.update','grafik-bb-tb-pr.delete','grafik-bb-tb-pr.data','grafik-lingkar-pr.index','grafik-lingkar-pr.create',
'grafik-lingkar-pr.store','grafik-lingkar-pr.edit','grafik-lingkar-pr.update','grafik-lingkar-pr.delete','grafik-lingkar-pr.data',
'grafik-imt-lk.index','grafik-imt-lk.create','grafik-imt-lk.store','grafik-imt-lk.edit','grafik-imt-lk.update',
'grafik-imt-lk.delete','grafik-imt-lk.data','grafik-imt-pr.index','grafik-imt-pr.create','grafik-imt-pr.store',
'grafik-imt-pr.edit','grafik-imt-pr.update','grafik-imt-pr.delete','grafik-imt-pr.data',
...
'admin.components.create-modal','admin.components.edit-modal','admin.components.table','admin.layouts-grafik.layout','admin.layouts-grafik.main',
'admin.layouts-grafik.template-grafik','admin.layouts.footer','admin.layouts.header','admin.layouts.layout','admin.layouts.sidebar',
'admin.layouts.sign-layout','admin.layouts2.ajax','admin.layouts2.anc','admin.layouts2.create-modal','admin.layouts2.delete-modal',
'admin.layouts2.edit-modal','admin.layouts2.header','admin.layouts2.layout','admin.layouts2.main','admin.layouts2.sidebar',
'admin.layouts2.template-table','admin.pages.404','admin.pages.animations','admin.pages.blank','admin.pages.borders',
'admin.pages.buttons','admin.pages.cards','admin.pages.charts','admin.pages.coba-grafik','admin.pages.colors',
'admin.pages.dashboard','admin.pages.dashboard-lama','admin.pages.forgot-password','admin.pages.ibu','admin.pages.identitas-anak',
'admin.pages.keluarga','admin.pages.login','admin.pages.other','admin.pages.register','admin.pages.tables',
'admin.pages.template-graph','admin.pages.template-table','auth.confirm-password','auth.forgot-password','auth.login',
...
'partials.script-dashboard','partials.script-dinamis','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','welcome','datatables-export::export-button','datatables-export::export-email','datatables::editor',
...
'validation.uuid','validation.custom.attribute-name.rule-name','id.0','actions.accept','actions.action',
