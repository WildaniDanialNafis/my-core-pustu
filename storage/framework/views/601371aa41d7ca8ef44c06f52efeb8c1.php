<?php $__env->startSection('title', 'Pemantauan Nifas Hari ke 1-7'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-4">
        ...
        <div class="text-center my-4">
            ...
            <h4 class="fw-bold mb-0">HARI KE 1-7</h4>
        ...
        <div class="border border-dark p-3 mb-4 rounded">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th class="text-center fw-semibold" style="width: 15%">Hari ke-</th>
                        <th class="text-center fw-semibold" style="width: 25%">Kondisi Ibu</th>
                        <th class="text-center fw-semibold" style="width: 20%">Tekanan Darah</th>
                        <th class="text-center fw-semibold" style="width: 15%">Nadi</th>
                        <th class="text-center fw-semibold" style="width: 25%">Lochia</th>
                    </tr>
                </thead>
                <tbody>
                    <?php for($i = 1; $i <= 7; $i++): ?>
                        <tr>
                            ...
                            <td><?php echo e($data_pemantauan[$i]['kondisi'] ?? '.........................'); ?></td>
                            <td><?php echo e($data_pemantauan[$i]['tekanan_darah'] ?? '.........................'); ?></td>
                            <td><?php echo e($data_pemantauan[$i]['nadi'] ?? '.........................'); ?></td>
                            <td><?php echo e($data_pemantauan[$i]['lochia'] ?? '.........................'); ?></td>
                        </tr>
                    <?php endfor; ?>
                </tbody>
            </table>
...
<?php echo $__env->make('layouts.print', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/my-core-pustu/resources/views/kia/print/form_nifas_1_7.blade.php ENDPATH**/ ?>