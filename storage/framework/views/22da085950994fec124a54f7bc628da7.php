<?php $__env->startSection('title', 'Pencatatan Imunisasi Anak'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-4">
        ...
        <div class="text-center my-4">
            ...
            <p class="fw-semibold">No. Register Kohort: <?php echo e($data_anak['no_register'] ?? '.........................'); ?></p>
        </div>
        ...
        <div class="border border-dark p-3 mb-4 rounded">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-4">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e($data_anak['jenis_kelamin'] ?? '.........................'); ?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-3">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <td>
                            <?php if(!empty($data['tanggal']) && $data['tanggal'] != '-'): ?>
                                <?php echo e(\Carbon\Carbon::parse($data['tanggal'])->isoFormat('D MMMM Y')); ?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-3">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e($data_anak['berat_lahir'] ?? '......'); ?> gram
                    </div>
                </div>
                <div class="col-sm-2 col-form-label fw-semibold">Panjang Lahir</div>
                <div class="col-sm-4">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e($data_anak['panjang_lahir'] ?? '......'); ?> cm
                    </div>
                </div>
            </div>
            <div class="row mb-2">
        ...
        <div class="border border-dark p-3 mb-4 rounded">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php $__currentLoopData = $vaksin_dasar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <tr>
                            ...
                            <td><?php echo e(optional($data)->tanggal ? \Carbon\Carbon::parse($data->tanggal)->isoFormat('D MMMM Y') : '.........................'); ?>

                            </td>
                            <td class="text-center">
                                <?php if($data && $anak->tgl_lahir): ?>
                                    <?php echo e(\Carbon\Carbon::parse($data->tanggal)->diffInMonths($anak->tgl_lahir)); ?> Bulan
                                <?php else: ?>
                                    -
                                <?php endif; ?>
                            </td>
                            <td><?php echo e(optional($data)->tempat ?? '.........................'); ?></td>
                            <td><?php echo e(optional($data)->paraf ?? '.........................'); ?></td>
                        </tr>
        ...
        <div class="border border-dark p-3 mb-4 rounded">
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($anak->bayiBaruLahir->first())->keterangan_tambahan ?? '...............................................................................................................'); ?>
        ...
        <div class="signature-container"
            ...
            <div class="text-center" style="width: 48%;">
                <p style="margin-bottom: 0.5rem; font-size: 12pt;"><?php echo e($anak->kabupaten ?? 'Kota Contoh'); ?>,
...
<?php echo $__env->make('layouts.print', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/my-core-pustu/resources/views/kia/print/imunisasi_anak.blade.php ENDPATH**/ ?>