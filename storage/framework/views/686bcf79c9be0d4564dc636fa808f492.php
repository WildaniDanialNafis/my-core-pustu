        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                ...
                <div class="list-group list-group-flush">
                    <a href="<?php echo e(route('kia.rujukan.ibu-hamil', ['id_ibu' => 1, 'iframe' => true])); ?>"
                    ...
                    <a href="<?php echo e(route('kia.rujukan.skrining-preeklampsia', ['id_ibu' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
                        <i class="fas fa-stethoscope me-2"></i> Skrining Preeklampsia
                    </a>
                    <a href="<?php echo e(route('kia.rujukan.anc-trimester1', ['id_ibu' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
                        <i class="fas fa-pills me-2"></i> Pemantauan ANC Trimester 1
                    </a>
                    <a href="<?php echo e(route('kia.rujukan.anc-trimester2', ['id_ibu' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
                        <i class="fas fa-pills me-2"></i> Pemantauan ANC Trimester 2
                    </a>
                    <a href="<?php echo e(route('kia.rujukan.anc-trimester3', ['id_ibu' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
                        <i class="fas fa-pills me-2"></i> Pemantauan ANC Trimester 3
                    </a>
                    <a href="<?php echo e(route('kia.rujukan.rujukan-kia', ['id_ibu' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
            ...
            <div class="card mb-4">
                ...
                <div class="list-group list-group-flush">
                    <a href="<?php echo e(route('kia.rujukan.persalinan', ['id_ibu' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
            ...
            <div class="card mb-4">
                ...
                <div class="list-group list-group-flush">
                    <a href="<?php echo e(route('kia.rujukan.nifas-6jam', ['id_ibu' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
                        <i class="fas fa-clock me-2"></i> Form Nifas 6 Jam Pertama
                    </a>
                    <a href="<?php echo e(route('kia.rujukan.nifas-1-7', ['id_ibu' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
                        <i class="fas fa-calendar-week me-2"></i> Form Nifas Hari 1-7
                    </a>
                    <a href="<?php echo e(route('kia.rujukan.nifas-2-6', ['id_ibu' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
                        <i class="fas fa-calendar me-2"></i> Form Nifas Minggu 2-6
                    </a>
                    <a href="<?php echo e(route('kia.rujukan.kb-pasca-persalinan', ['id_ibu' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
            ...
            <div class="card mb-4">
                ...
                <div class="list-group list-group-flush">
                    <a href="<?php echo e(route('kia.rujukan.bayi-baru-lahir', ['id_bayi' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
                        <i class="fas fa-baby-carriage me-2"></i> Form Bayi Baru Lahir
                    </a>
                    <a href="<?php echo e(route('kia.rujukan.neonatal-07', ['id_bayi' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
                        <i class="fas fa-calendar-day me-2"></i> Kunjungan Neonatal 0-7 Hari
                    </a>
                    <a href="<?php echo e(route('kia.rujukan.neonatal-828', ['id_bayi' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
                        <i class="fas fa-calendar-alt me-2"></i> Kunjungan Neonatal 8-28 Hari
                    </a>
                    <a href="<?php echo e(route('kia.rujukan.imunisasi-anak', ['id_bayi' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
                        <i class="fas fa-syringe me-2"></i> Pencatatan Imunisasi Anak
                    </a>
                    <a href="<?php echo e(route('kia.rujukan.rujukan-bayi', ['id_bayi' => 1, 'iframe' => true])); ?>"
                        class="list-group-item list-group-item-action form-link" target="form-iframe">
...
<?php /**PATH /var/www/my-core-pustu/resources/views/admin/layouts2/cetak-form.blade.php ENDPATH**/ ?>