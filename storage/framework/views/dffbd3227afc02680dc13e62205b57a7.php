<?php $__env->startSection('title', 'Pelayanan KB Pasca Persalinan'); ?>
    ...
    <div class="container-fluid px-4">
        ...
        <div class="border border-dark p-3 mb-4 rounded">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-9">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($ibu->keluarga->firstWhere('status', 'suami'))->nama ?? '.........................'); ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($nifas)->tanggal_persalinan ? \Carbon\Carbon::parse($nifas->tanggal_persalinan)->isoFormat('D MMMM Y') : '.........................'); ?>
                ...
                <div class="col-sm-4">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($bayi->tanggal_lahir) ? now()->diffInDays($bayi->tanggal_lahir).' Hari' : '......'); ?>
        ...
        <div class="border border-dark p-3 mb-4 rounded">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-3">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($nifas)->jenis_kb ?? '.........................'); ?>
                ...
                <div class="col-sm-3">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($nifas)->tanggal_mulai_kb ? \Carbon\Carbon::parse($nifas->tanggal_mulai_kb)->isoFormat('D MMMM Y') : '.........................'); ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($nifas)->tempat_kb ?? '.........................'); ?>
                ...
                <div class="col-sm-3">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($nifas)->petugas_kb ?? '.........................'); ?>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <div class="form-control-plaintext border-bottom border-dark ps-2">
                                <?php echo e(optional($nifas)->tekanan_darah ?? '......'); ?> mmHg
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <div class="form-control-plaintext border-bottom border-dark ps-2">
                                <?php echo e(optional($nifas)->nadi ?? '......'); ?> /menit
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <div class="form-control-plaintext border-bottom border-dark ps-2">
                                <?php echo e(optional($nifas)->kondisi_rahim ?? '.........................'); ?>
                ...
                <div class="col-md-3">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <div class="form-control-plaintext border-bottom border-dark ps-2">
                                <?php echo e(optional($nifas)->laktasi ?? '.........................'); ?>
        ...
        <div class="border border-dark p-3 mb-4 rounded">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($nifas)->tanggal_konseling_kb ? \Carbon\Carbon::parse($nifas->tanggal_konseling_kb)->isoFormat('D MMMM Y') : '.........................'); ?>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($nifas)->materi_konseling_kb ?? '...............................................................................................................'); ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($nifas)->kesimpulan_konseling_kb ?? '...............................................................................................................'); ?>
        ...
        <div class="border border-dark p-3 mb-4 rounded">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($nifas)->tanggal_kontrol_kb ? \Carbon\Carbon::parse($nifas->tanggal_kontrol_kb)->isoFormat('D MMMM Y') : '.........................'); ?>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($nifas)->efek_samping_kb ?? '...............................................................................................................'); ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        <?php echo e(optional($nifas)->keterangan_kb ?? '...............................................................................................................'); ?>
...
<?php echo $__env->make('layouts.print', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/my-core-pustu/resources/views/kia/print/kb_pasca_persalinan.blade.php ENDPATH**/ ?>