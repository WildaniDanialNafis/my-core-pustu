                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="formTambahData" method="POST" action="<?php echo e(route('tables.store')); ?>">
                                <?php echo csrf_field(); ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="editUserForm" method="POST"
                                    action="<?php echo e(route('tables.update', ['id' => ':id'])); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /app/resources/views/admin/pages/identitas-anak.blade.php ENDPATH**/ ?>