...
<body>
    ...
    <script>
        ...
        function loadPage(url, pushState = false) {
            ...
            if (normalizedUrl === '/dashboard') {
            ...
            } else if (normalizedUrl === '/grafik-bb-u-lk') {
                loadGrafikBbULk();
            } else if (normalizedUrl === '/grafik-tb-u-lk') {
                loadGrafikTbULk();
            } else if (normalizedUrl === '/grafik-bb-tb-lk') {
                loadGrafikBbTbLk();
            } else if (normalizedUrl === '/grafik-lingkar-lk') {
                loadGrafikLingkarLk();
                ...
                loadGrafikLingkarPr();
            } else if (normalizedUrl === '/grafik-imt-lk') {
                loadGrafikImtLk();
