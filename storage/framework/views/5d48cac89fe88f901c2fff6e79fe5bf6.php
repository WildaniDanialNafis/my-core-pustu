...
<body>
    <!-- Header -->
    <?php echo $__env->make('admin.layouts2.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <!-- Sidebar -->
    <?php echo $__env->make('admin.layouts2.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <script src="<?php echo e(asset('sidebar/sidebar-search.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('components/initialize-line-chart.js')); ?>"></script>

    <script src="<?php echo e(asset('components/initialize-doughnut-chart.js')); ?>"></script>

        <script src="<?php echo e(asset('components/initialize-dashboard-line-chart.js')); ?>"></script>

    <script src="<?php echo e(asset('components/initialize-dashboard-doughnut-chart.js')); ?>"></script>
...
<?php /**PATH /var/www/my-core-pustu/resources/views/admin/layouts2/layout.blade.php ENDPATH**/ ?>