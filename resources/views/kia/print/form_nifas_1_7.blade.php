...
@section('title', 'Pemantauan Nifas Hari ke 1-7')
                ...
                <tbody>
                    @for ($i = 1; $i <= 7; $i++)
                        <tr>
                            ...
                            <td>{{ $data_pemantauan[$i]['kondisi'] ?? '.........................' }}</td>
                            <td>{{ $data_pemantauan[$i]['tekanan_darah'] ?? '.........................' }}</td>
                            <td>{{ $data_pemantauan[$i]['nadi'] ?? '.........................' }}</td>
                            <td>{{ $data_pemantauan[$i]['lochia'] ?? '.........................' }}</td>
                        </tr>
                    @endfor
                </tbody>
            </table>
