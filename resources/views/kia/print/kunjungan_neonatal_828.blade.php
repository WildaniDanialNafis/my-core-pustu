...
@section('title', 'Kunjungan Neonatal 8-28 Hari')
    ...
    <div class="container-fluid px-4">
        ...
        <div class="border border-dark p-3 mb-4 rounded">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-9">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        {{ $bayi->tanggal_lahir ? \Carbon\Carbon::parse($bayi->tanggal_lahir)->isoFormat('D MMMM Y') : '.........................' }}
                    </div>
                </div>
            </div>
            <div class="row mb-2">
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="form-control-plaintext border-bottom border-dark ps-2">
                        {{ \Carbon\Carbon::parse($kunjungan)->isoFormat('D MMMM Y') }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="signature-container"
            ...
            <div class="text-center" style="width: 48%;">
                <p style="margin-bottom: 0.5rem; font-size: 12pt;">{{ $tempat ?? 'Kota Contoh' }}, 
                    {{ \Carbon\Carbon::parse($kunjungan)->isoFormat('D MMMM Y') }}</p>
