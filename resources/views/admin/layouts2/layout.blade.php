...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('buttons.bootstrap5.min.css') }}">
...
<body>
    ...
    <script src="{{ asset('buttons.bootstrap5.min.js') }}"></script>
    ...
    <script src="{{ asset('sidebar/sidebar-search.js') }}"></script>
    ...
    <script src="{{ asset('components/initialize-line-chart.js') }}"></script>

    <script src="{{ asset('components/initialize-doughnut-chart.js') }}"></script>

        <script src="{{ asset('components/initialize-dashboard-line-chart.js') }}"></script>

    <script src="{{ asset('components/initialize-dashboard-doughnut-chart.js') }}"></script>
    ...
    <script src="{{ asset('graph/template-grafik.js') }}"></script>
