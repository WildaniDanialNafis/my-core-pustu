            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="login-container">
                                ...
                                <form id="loginForm" class="user" action="{{ route('login') }}" method="POST">
                                    ...
                                    @if (Route::has('register'))
                                        <div class="text-center mt-3">
                                            <p class="mb-0 small">Belum punya akun? <a href="{{ route('register') }}"
                        ...
                        <div class="text-center mt-3">
                            <p class="small text-white">© {{ date('Y') }} Dinas Kesehatan. Sistem Informasi
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-start">
                    <span class="small">Versi 2.1.0 | Terakhir diperbarui: {{ date('F Y') }}</span>
                </div>
