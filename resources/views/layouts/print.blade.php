...
<head>
    ...
    <title>@yield('title', 'Dokumen Kesehatan')</title>
...
<body>
    ...
    <div class="container">
        ...
        <footer class="footer no-print">
            <div class="text-center text-small text-muted mt-4">
                ...
                <p>Dicetak pada: {{ \Carbon\Carbon::now()->isoFormat('D MMMM Y HH:mm:ss') }}</p>
            </div>
        </footer>
    </div>
    ...
    {{-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Auto print after 500ms if auto-print class exists
            if (document.querySelector('.auto-print')) {
                setTimeout(function() {
                    window.print();
