...
use App\Http\Controllers\GrafikBbTbLakiController;
use App\Http\Controllers\GrafikBbTbPrController;
use App\Http\Controllers\GrafikBbUPrController;
use App\Http\Controllers\GrafikBeratBadanUmurLakiController;
use App\Http\Controllers\GrafikImtLakiController;
use App\Http\Controllers\GrafikImtPrController;
use App\Http\Controllers\GrafikLingkarLakiController;
use App\Http\Controllers\GrafikLingkarPrController;
use App\Http\Controllers\GrafikTbUPrController;
use App\Http\Controllers\GrafikTinggiBadanUmurLakiController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::group([], function () {
        ...
        Route::get('/ibu-bersalin', [IbuBersalinController::class, 'index'])->name('ibu-bersalin.index');
        Route::post('/ibu-bersalin/create', [IbuBersalinController::class, 'create'])->name('ibu-bersalin.create');
        Route::post('/ibu-bersalin/store', [IbuBersalinController::class, 'store'])->name('ibu-bersalin.store');
        Route::get('/ibu-bersalin/edit/{id}', [IbuBersalinController::class, 'edit'])->name('ibu-bersalin.edit');
        Route::put('/ibu-bersalin/update/{id}', [IbuBersalinController::class, 'update'])->name('ibu-bersalin.update');
        Route::delete('/ibu-bersalin/delete/{id}', [IbuBersalinController::class, 'destroy'])->name('ibu-bersalin.delete');

        Route::get('/bayi-lahir', [BayiLahirController::class, 'index'])->name('bayi-lahir.index');
        Route::post('/bayi-lahir/create', [BayiLahirController::class, 'create'])->name('bayi-lahir.create');
        Route::post('/bayi-lahir/store', [BayiLahirController::class, 'store'])->name('bayi-lahir.store');
        Route::get('/bayi-lahir/edit/{id}', [BayiLahirController::class, 'edit'])->name('bayi-lahir.edit');
        Route::put('/bayi-lahir/update/{id}', [BayiLahirController::class, 'update'])->name('bayi-lahir.update');
        Route::delete('/bayi-lahir/delete/{id}', [BayiLahirController::class, 'destroy'])->name('bayi-lahir.delete');
        ...
        Route::get('/ibu/export', [IbuController::class, 'exportExcel'])->name('ibu.export');
        Route::get('/ibu2/export', [Ibu2Controller::class, 'exportExcel'])->name('ibu2.export');
        Route::get('/keluarga/export', [KeluargaController::class, 'exportExcel'])->name('keluarga.export');
        Route::get('/kesehatan1/export', [Kesehatan1Controller::class, 'exportExcel'])->name('kesehatan1.export');
        Route::get('/kesehatan2/export', [Kesehatan2Controller::class, 'exportExcel'])->name('kesehatan2.export');
        Route::get('/kesehatan-bersalin/export', [KesehatanBersalinController::class, 'exportExcel'])->name('kesehatan-bersalin.export');
        Route::get('/kesehatan-nifas/export', [KesehatanNifasController::class, 'exportExcel'])->name('kesehatan-nifas.export');
        Route::get('/kontrol-ttd/export', [KontrolTtdController::class, 'exportExcel'])->name('kontrol-ttd.export');
        Route::get('/minum-ttd/export', [MinumTtdController::class, 'exportExcel'])->name('minum-ttd.export');
        Route::get('/menyambut-persalinan/export', [MenyambutPersalinanController::class, 'exportExcel'])->name('menyambut-persalinan.export');
        Route::get('/amanat-penolong-persalinan/export', [AmanatPenolongPersalinanController::class, 'exportExcel'])->name('amanat-penolong-persalinan.export');
        Route::get('/amanat-kendaraan/export', [AmanatKendaraanController::class, 'exportExcel'])->name('amanat-kendaraan.export');
        Route::get('/amanat-darah/export', [AmanatDarahController::class, 'exportExcel'])->name('amanat-darah.export');
        Route::get('/evaluasi-kesehatan-bumil/export', [EvaluasiKesehatanBumilController::class, 'exportExcel'])->name('evaluasi-kesehatan-bumil.export');
        Route::get('/kondisi-kesehatan-bumil/export', [KondisiKesehatanBumilController::class, 'exportExcel'])->name('kondisi-kesehatan-bumil.export');
        Route::get('/imunisasi-t/export', [ImunisasiTController::class, 'exportExcel'])->name('imunisasi-t.export');
        Route::get('/riwayat-kesehatan-bumil/export', [RiwayatKesehatanBumilController::class, 'exportExcel'])->name('riwayat-kesehatan-bumil.export');
        Route::get('/riwayat-perilaku-berisiko/export', [RiwayatPerilakuBerisikoController::class, 'exportExcel'])->name('riwayat-perilaku-berisiko.export');
        Route::get('/riwayat-kehamilan/export', [RiwayatKehamilanController::class, 'exportExcel'])->name('riwayat-kehamilan.export');
        Route::get('/riwayat-penyakit-keluarga/export', [RiwayatPenyakitKeluargaController::class, 'exportExcel'])->name('riwayat-penyakit-keluarga.export');
        Route::get('/pemeriksaan-khusus/export', [PemeriksaanKhususController::class, 'exportExcel'])->name('pemeriksaan-khusus.export');
        Route::get('/pemeriksaan-trimester1/export', [PemeriksaanTrimester1Controller::class, 'exportExcel'])->name('pemeriksaan-trimester1.export');
        Route::get('/pemeriksaan-fisik-tri1/export', [PemeriksaanFisikTri1Controller::class, 'exportExcel'])->name('pemeriksaan-fisik-tri1.export');
        Route::get('/usg-tri1/export', [UsgTri1Controller::class, 'exportExcel'])->name('usg-tri1.export');
        Route::get('/pemeriksaan-laboratorium-tri1/export', [PemeriksaanLaboratoriumTri1Controller::class, 'exportExcel'])->name('pemeriksaan-laboratorium-tri1.export');
        Route::get('/evaluasi-kehamilan/export', [EvaluasiKehamilanController::class, 'exportExcel'])->name('evaluasi-kehamilan.export');
        Route::get('/berat-badan-bumil/export', [BeratBadanBumilController::class, 'exportExcel'])->name('berat-badan-bumil.export');
        Route::get('/skrining-preeklampsia/export', [SkriningPreeklampsiaController::class, 'exportExcel'])->name('skrining-preeklampsia.export');
        Route::get('/preeklampsia-anamnesis/export', [PreeklampsiaAnamnesisController::class, 'exportExcel'])->name('preeklampsia-anamnesis.export');
        Route::get('/preeklampsia-fisik/export', [PreeklampsiaFisikController::class, 'exportExcel'])->name('preeklampsia-fisik.export');
        Route::get('/pemeriksaan-trimester3/export', [PemeriksaanTrimester3Controller::class, 'exportExcel'])->name('pemeriksaan-trimester3.export');
        Route::get('/pemeriksaan-fisik-tri3/export', [PemeriksaanFisikTri3Controller::class, 'exportExcel'])->name('pemeriksaan-fisik-tri3.export');
        Route::get('/usg-tri3/export', [UsgTri3Controller::class, 'exportExcel'])->name('usg-tri3.export');
        Route::get('/pemeriksaan-laboratorium-tri3/export', [PemeriksaanLaboratoriumTri3Controller::class, 'exportExcel'])->name('pemeriksaan-laboratorium-tri3.export');
        Route::get('/ringkasan-kesehatan/export', [RingkasanKesehatanController::class, 'exportExcel'])->name('ringkasan-kesehatan.export');
        Route::get('/ibu-bersalin/export', [IbuBersalinController::class, 'exportExcel'])->name('ibu-bersalin.export');
        Route::get('/bayi-lahir/export', [BayiLahirController::class, 'exportExcel'])->name('bayi-lahir.export');
        Route::get('/ringkasan-nifas/export', [RingkasanNifasController::class, 'exportExcel'])->name('ringkasan-nifas.export');
        Route::get('/ringkasan-kesimpulan-nifas/export', [RingkasanKesimpulanNifasController::class, 'exportExcel'])->name('ringkasan-kesimpulan-nifas.export');
        Route::get('/rujukan/export', [RujukanController::class, 'exportExcel'])->name('rujukan.export');
        Route::get('/wali/export', [WaliController::class, 'exportExcel'])->name('wali.export');

        Route::post('/ibu/import', [IbuController::class, 'importExcel'])->name('ibu.import');
        Route::post('/ibu2/import', [Ibu2Controller::class, 'importExcel'])->name('ibu2.import');
        Route::post('/keluarga/import', [KeluargaController::class, 'importExcel'])->name('keluarga.import');
        Route::post('/kesehatan1/import', [Kesehatan1Controller::class, 'importExcel'])->name('kesehatan1.import');
        Route::post('/kesehatan2/import', [Kesehatan2Controller::class, 'importExcel'])->name('kesehatan2.import');
        Route::post('/kesehatan-bersalin/import', [KesehatanBersalinController::class, 'importExcel'])->name('kesehatan-bersalin.import');
        Route::post('/kesehatan-nifas/import', [KesehatanNifasController::class, 'importExcel'])->name('kesehatan-nifas.import');
        Route::post('/kontrol-ttd/import', [KontrolTtdController::class, 'importExcel'])->name('kontrol-ttd.import');
        Route::post('/minum-ttd/import', [MinumTtdController::class, 'importExcel'])->name('minum-ttd.import');
        Route::post('/menyambut-persalinan/import', [MenyambutPersalinanController::class, 'importExcel'])->name('menyambut-persalinan.import');
        Route::post('/amanat-penolong-persalinan/import', [AmanatPenolongPersalinanController::class, 'importExcel'])->name('amanat-penolong-persalinan.import');
        Route::post('/amanat-kendaraan/import', [AmanatKendaraanController::class, 'importExcel'])->name('amanat-kendaraan.import');
        Route::post('/amanat-darah/import', [AmanatDarahController::class, 'importExcel'])->name('amanat-darah.import');
        Route::post('/evaluasi-kesehatan-bumil/import', [EvaluasiKesehatanBumilController::class, 'importExcel'])->name('evaluasi-kesehatan-bumil.import');
        Route::post('/kondisi-kesehatan-bumil/import', [KondisiKesehatanBumilController::class, 'importExcel'])->name('kondisi-kesehatan-bumil.import');
        Route::post('/imunisasi-t/import', [ImunisasiTController::class, 'importExcel'])->name('imunisasi-t.import');
        Route::post('/riwayat-kesehatan-bumil/import', [RiwayatKesehatanBumilController::class, 'importExcel'])->name('riwayat-kesehatan-bumil.import');
        Route::post('/riwayat-perilaku-berisiko/import', [RiwayatPerilakuBerisikoController::class, 'importExcel'])->name('riwayat-perilaku-berisiko.import');
        Route::post('/riwayat-kehamilan/import', [RiwayatKehamilanController::class, 'importExcel'])->name('riwayat-kehamilan.import');
        Route::post('/riwayat-penyakit-keluarga/import', [RiwayatPenyakitKeluargaController::class, 'importExcel'])->name('riwayat-penyakit-keluarga.import');
        Route::post('/pemeriksaan-khusus/import', [PemeriksaanKhususController::class, 'importExcel'])->name('pemeriksaan-khusus.import');
        Route::post('/pemeriksaan-trimester1/import', [PemeriksaanTrimester1Controller::class, 'importExcel'])->name('pemeriksaan-trimester1.import');
        Route::post('/pemeriksaan-fisik-tri1/import', [PemeriksaanFisikTri1Controller::class, 'importExcel'])->name('pemeriksaan-fisik-tri1.import');
        Route::post('/usg-tri1/import', [UsgTri1Controller::class, 'importExcel'])->name('usg-tri1.import');
        Route::post('/pemeriksaan-laboratorium-tri1/import', [PemeriksaanLaboratoriumTri1Controller::class, 'importExcel'])->name('pemeriksaan-laboratorium-tri1.import');
        Route::post('/evaluasi-kehamilan/import', [EvaluasiKehamilanController::class, 'importExcel'])->name('evaluasi-kehamilan.import');
        Route::post('/berat-badan-bumil/import', [BeratBadanBumilController::class, 'importExcel'])->name('berat-badan-bumil.import');
        Route::post('/skrining-preeklampsia/import', [SkriningPreeklampsiaController::class, 'importExcel'])->name('skrining-preeklampsia.import');
        Route::post('/preeklampsia-anamnesis/import', [PreeklampsiaAnamnesisController::class, 'importExcel'])->name('preeklampsia-anamnesis.import');
        Route::post('/preeklampsia-fisik/import', [PreeklampsiaFisikController::class, 'importExcel'])->name('preeklampsia-fisik.import');
        Route::post('/pemeriksaan-trimester3/import', [PemeriksaanTrimester3Controller::class, 'importExcel'])->name('pemeriksaan-trimester3.import');
        Route::post('/pemeriksaan-fisik-tri3/import', [PemeriksaanFisikTri3Controller::class, 'importExcel'])->name('pemeriksaan-fisik-tri3.import');
        Route::post('/usg-tri3/import', [UsgTri3Controller::class, 'importExcel'])->name('usg-tri3.import');
        Route::post('/pemeriksaan-laboratorium-tri3/import', [PemeriksaanLaboratoriumTri3Controller::class, 'importExcel'])->name('pemeriksaan-laboratorium-tri3.import');
        Route::post('/ringkasan-kesehatan/import', [RingkasanKesehatanController::class, 'importExcel'])->name('ringkasan-kesehatan.import');
        Route::post('/ibu-bersalin/import', [IbuBersalinController::class, 'importExcel'])->name('ibu-bersalin.import');
        Route::post('/bayi-lahir/import', [BayiLahirController::class, 'importExcel'])->name('bayi-lahir.import');
        Route::post('/ringkasan-nifas/import', [RingkasanNifasController::class, 'importExcel'])->name('ringkasan-nifas.import');
        Route::post('/ringkasan-kesimpulan-nifas/import', [RingkasanKesimpulanNifasController::class, 'importExcel'])->name('ringkasan-kesimpulan-nifas.import');
        Route::post('/rujukan/import', [RujukanController::class, 'importExcel'])->name('rujukan.import');
        Route::post('/wali/import', [WaliController::class, 'importExcel'])->name('wali.import');
    });
    ...
    Route::group([], function () {
        ...
        Route::get('/anak/export', [AnakController::class, 'exportExcel'])->name('anak.export');
        Route::get('/identitas-anak/export', [IdentitasAnakController::class, 'exportExcel'])->name('identitas.anak.export');
        Route::get('/bayi-baru-lahir/export', [BayiBaruLahirController::class, 'exportExcel'])->name('bayi-baru-lahir.export');
        Route::get('/bayi/export', [BayiController::class, 'exportExcel'])->name('bayi.export');
        Route::get('/anak-balita/export', [AnakBalitaController::class, 'exportExcel'])->name('anak-balita.export');
        Route::get('/keterangan-lahir/export', [KeteranganLahirController::class, 'exportExcel'])->name('keterangan-lahir.export');
        Route::get('/riwayat-kelahiran/export', [RiwayatKelahiranController::class, 'exportExcel'])->name('riwayat-kelahiran.export');
        Route::get('/pelayanan-kesehatan-neonatus/export', [PelayananKesehatanNeonatusController::class, 'exportExcel'])->name('pelayanan-kesehatan-neonatus.export');
        Route::get('/kn0/export', [KN0Controller::class, 'exportExcel'])->name('kn0.export');
        Route::get('/kn1/export', [KN1Controller::class, 'exportExcel'])->name('kn1.export');
        Route::get('/kn2/export', [KN2Controller::class, 'exportExcel'])->name('kn2.export');
        Route::get('/kn3/export', [KN3Controller::class, 'exportExcel'])->name('kn3.export');
        Route::get('/imunisasi/export', [ImunisasiController::class, 'exportExcel'])->name('imunisasi.export');
        Route::get('/pemantauan-kia/export', [PemantauanKiaController::class, 'exportExcel'])->name('pemantauan-kia.export');
        Route::get('/pelayanan-sdidtk/export', [PelayananSdidtkController::class, 'exportExcel'])->name('pelayanan-sdidtk.export');
        Route::get('/penyimpangan-pertumbuhan/export', [PenyimpanganPertumbuhanController::class, 'exportExcel'])->name('penyimpangan-pertumbuhan.export');
        Route::get('/penyimpangan-perkembangan/export', [PenyimpanganPerkembanganController::class, 'exportExcel'])->name('penyimpangan-perkembangan.export');
        Route::get('/penyimpangan-emosional/export', [PenyimpanganEmosionalController::class, 'exportExcel'])->name('penyimpangan-emosional.export');
        Route::get('/nasihat-anak/export', [NasihatAnakController::class, 'exportExcel'])->name('nasihat-anak.export');
        Route::get('/kapsul-anak/export', [KapsulAnakController::class, 'exportExcel'])->name('kapsul-anak.export');
        Route::get('/kms-perempuan/export', [KmsPerempuanController::class, 'exportExcel'])->name('kms-perempuan.export');
        Route::get('/data-kms-perempuan/export', [DataKmsPerempuanController::class, 'exportExcel'])->name('data-kms-perempuan.export');
        Route::get('/bb-u-perempuan/export', [BbUPerempuanController::class, 'exportExcel'])->name('bb-u-perempuan.export');
        Route::get('/tb-u-perempuan/export', [TbUPerempuanController::class, 'exportExcel'])->name('tb-u-perempuan.export');
        Route::get('/bb-tb-perempuan/export', [BbTbPerempuanController::class, 'exportExcel'])->name('bb-tb-perempuan.export');
        Route::get('/lingkar-kepala-perempuan/export', [LingkarKepalaPerempuanController::class, 'exportExcel'])->name('lingkar-kepala-perempuan.export');
        Route::get('/kms-laki/export', [KmsLakiController::class, 'exportExcel'])->name('kms-laki.export');
        Route::get('/data-kms-laki/export', [DataKmsLakiController::class, 'exportExcel'])->name('data-kms-laki.export');
        Route::get('/bb-u-laki/export', [BbULakiController::class, 'exportExcel'])->name('bb-u-laki.export');
        Route::get('/tb-u-laki/export', [TbULakiController::class, 'exportExcel'])->name('tb-u-laki.export');
        Route::get('/bb-tb-laki/export', [BbTbLakiController::class, 'exportExcel'])->name('bb-tb-laki.export');
        Route::get('/lingkar-kepala-laki/export', [LingkarKepalaLakiController::class, 'exportExcel'])->name('lingkar-kepala-laki.export');
        Route::get('/imt-perempuan/export', [ImtPerempuanController::class, 'exportExcel'])->name('imt-perempuan.export');
        Route::get('/imt-laki/export', [ImtLakiController::class, 'exportExcel'])->name('imt-laki.export');
        Route::get('/kesehatan-gigi/export', [KesehatanGigiController::class, 'exportExcel'])->name('kesehatan-gigi.export');
        Route::get('/data-kesehatan-gigi/export', [DataKesehatanGigiController::class, 'exportExcel'])->name('data-kesehatan-gigi.export');
        Route::get('/ringkasan-mtbs/export', [RingkasanMtbsController::class, 'exportExcel'])->name('ringkasan-mtbs.export');
        Route::get('/ringkasan-pelayanan-dokter/export', [RingkasanPelayananDokterController::class, 'exportExcel'])->name('ringkasan-pelayanan-dokter.export');
        Route::get('/rujukan-anak/export', [RujukanAnakController::class, 'exportExcel'])->name('rujukan-anak.export');

        Route::post('/anak/import', [AnakController::class, 'importExcel'])->name('anak.import');
        Route::post('/identitas-anak/import', [IdentitasAnakController::class, 'importExcel'])->name('identitas.anak.import');
        Route::post('/bayi-baru-lahir/import', [BayiBaruLahirController::class, 'importExcel'])->name('bayi-baru-lahir.import');
        Route::post('/bayi/import', [BayiController::class, 'importExcel'])->name('bayi.import');
        Route::post('/anak-balita/import', [AnakBalitaController::class, 'importExcel'])->name('anak-balita.import');
        Route::post('/keterangan-lahir/import', [KeteranganLahirController::class, 'importExcel'])->name('keterangan-lahir.import');
        Route::post('/riwayat-kelahiran/import', [RiwayatKelahiranController::class, 'importExcel'])->name('riwayat-kelahiran.import');
        Route::post('/pelayanan-kesehatan-neonatus/import', [PelayananKesehatanNeonatusController::class, 'importExcel'])->name('pelayanan-kesehatan-neonatus.import');
        Route::post('/kn0/import', [KN0Controller::class, 'importExcel'])->name('kn0.import');
        Route::post('/kn1/import', [KN1Controller::class, 'importExcel'])->name('kn1.import');
        Route::post('/kn2/import', [KN2Controller::class, 'importExcel'])->name('kn2.import');
        Route::post('/kn3/import', [KN3Controller::class, 'importExcel'])->name('kn3.import');
        Route::post('/imunisasi/import', [ImunisasiController::class, 'importExcel'])->name('imunisasi.import');
        Route::post('/pemantauan-kia/import', [PemantauanKiaController::class, 'importExcel'])->name('pemantauan-kia.import');
        Route::post('/pelayanan-sdidtk/import', [PelayananSdidtkController::class, 'importExcel'])->name('pelayanan-sdidtk.import');
        Route::post('/penyimpangan-pertumbuhan/import', [PenyimpanganPertumbuhanController::class, 'importExcel'])->name('penyimpangan-pertumbuhan.import');
        Route::post('/penyimpangan-perkembangan/import', [PenyimpanganPerkembanganController::class, 'importExcel'])->name('penyimpangan-perkembangan.import');
        Route::post('/penyimpangan-emosional/import', [PenyimpanganEmosionalController::class, 'importExcel'])->name('penyimpangan-emosional.import');
        Route::post('/nasihat-anak/import', [NasihatAnakController::class, 'importExcel'])->name('nasihat-anak.import');
        Route::post('/kapsul-anak/import', [KapsulAnakController::class, 'importExcel'])->name('kapsul-anak.import');
        Route::post('/kms-perempuan/import', [KmsPerempuanController::class, 'importExcel'])->name('kms-perempuan.import');
        Route::post('/data-kms-perempuan/import', [DataKmsPerempuanController::class, 'importExcel'])->name('data-kms-perempuan.import');
        Route::post('/bb-u-perempuan/import', [BbUPerempuanController::class, 'importExcel'])->name('bb-u-perempuan.import');
        Route::post('/tb-u-perempuan/import', [TbUPerempuanController::class, 'importExcel'])->name('tb-u-perempuan.import');
        Route::post('/bb-tb-perempuan/import', [BbTbPerempuanController::class, 'importExcel'])->name('bb-tb-perempuan.import');
        Route::post('/lingkar-kepala-perempuan/import', [LingkarKepalaPerempuanController::class, 'importExcel'])->name('lingkar-kepala-perempuan.import');
        Route::post('/kms-laki/import', [KmsLakiController::class, 'importExcel'])->name('kms-laki.import');
        Route::post('/data-kms-laki/import', [DataKmsLakiController::class, 'importExcel'])->name('data-kms-laki.import');
        Route::post('/bb-u-laki/import', [BbULakiController::class, 'importExcel'])->name('bb-u-laki.import');
        Route::post('/tb-u-laki/import', [TbULakiController::class, 'importExcel'])->name('tb-u-laki.import');
        Route::post('/bb-tb-laki/import', [BbTbLakiController::class, 'importExcel'])->name('bb-tb-laki.import');
        Route::post('/lingkar-kepala-laki/import', [LingkarKepalaLakiController::class, 'importExcel'])->name('lingkar-kepala-laki.import');
        Route::post('/imt-perempuan/import', [ImtPerempuanController::class, 'importExcel'])->name('imt-perempuan.import');
        Route::post('/imt-laki/import', [ImtLakiController::class, 'importExcel'])->name('imt-laki.import');
        Route::post('/kesehatan-gigi/import', [KesehatanGigiController::class, 'importExcel'])->name('kesehatan-gigi.import');
        Route::post('/data-kesehatan-gigi/import', [DataKesehatanGigiController::class, 'importExcel'])->name('data-kesehatan-gigi.import');
        Route::post('/ringkasan-mtbs/import', [RingkasanMtbsController::class, 'importExcel'])->name('ringkasan-mtbs.import');
        Route::post('/ringkasan-pelayanan-dokter/import', [RingkasanPelayananDokterController::class, 'importExcel'])->name('ringkasan-pelayanan-dokter.import');
        Route::post('/rujukan-anak/import', [RujukanAnakController::class, 'importExcel'])->name('rujukan-anak.import');
    });
    ...
    Route::prefix('grafik')->group(function () {
        ...
        Route::post('/grafik-bb-u-pr/store', [GrafikBbUPrController::class, 'store'])->name('grafik-bb-u-pr.store');
        ...
        Route::post('/grafik-tb-u-pr/store', [GrafikTbUPrController::class, 'store'])->name('grafik-tb-u-pr.store');
        ...
        Route::post('/grafik-bb-tb-pr/store', [GrafikBbTbPrController::class, 'store'])->name('grafik-bb-tb-pr.store');
        ...
        Route::post('/grafik-lingkar-pr/store', [GrafikLingkarPrController::class, 'store'])->name('grafik-lingkar-pr.store');
        ...
        Route::post('/grafik-imt-pr/store', [GrafikImtPrController::class, 'store'])->name('grafik-imt-pr.store');
