...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/bayi-baru-lahir/create', [BayiBaruLahirController::class, 'create'])->name('bayi-baru-lahir.create');
    ...
    Route::get('/anak-balita/create', [AnakBalitaController::class, 'create'])->name('anak-balita.create');
    ...
    Route::get('/keterangan-lahir/create', [KeteranganLahirController::class, 'create'])->name('keterangan-lahir.create');
    ...
    Route::get('/riwayat-kelahiran/create', [RiwayatKelahiranController::class, 'create'])->name('riwayat-kelahiran.create');
    ...
    Route::get('/pelayanan-kesehatan-neonatus/create', [PelayananKesehatanNeonatusController::class, 'create'])->name('pelayanan-kesehatan-neonatus.create');
    ...
    Route::get('/kn0/create', [KN0Controller::class, 'create'])->name('kn0.create');
    ...
    Route::get('/kn1/create', [KN1Controller::class, 'create'])->name('kn1.create');
    ...
    Route::get('/kn2/create', [KN2Controller::class, 'create'])->name('kn2.create');
    ...
    Route::get('/kn3/create', [KN3Controller::class, 'create'])->name('kn3.create');
    ...
    Route::get('/pemantauan-kia/create', [PemantauanKiaController::class, 'create'])->name('pemantauan-kia.create');
    ...
    Route::get('/pelayanan-sdidtk/create', [PelayananSdidtkController::class, 'create'])->name('pelayanan-sdidtk.create');
    ...
    Route::get('/penyimpangan-pertumbuhan/create', [PenyimpanganPertumbuhanController::class, 'create'])->name('penyimpangan-pertumbuhan.create');
    ...
    Route::get('/penyimpangan-perkembangan/create', [PenyimpanganPerkembanganController::class, 'create'])->name('penyimpangan-perkembangan.create');
    ...
    Route::get('/penyimpangan-emosional/create', [PenyimpanganEmosionalController::class, 'create'])->name('penyimpangan-emosional.create');
    ...
    Route::get('/nasihat-anak/create', [NasihatAnakController::class, 'create'])->name('nasihat-anak.create');
    ...
    Route::get('/kapsul-anak/create', [KapsulAnakController::class, 'create'])->name('kapsul-anak.create');
    ...
    Route::get('/kms-perempuan/create', [KmsPerempuanController::class, 'create'])->name('kms-perempuan.create');
    ...
    Route::get('/data-kms-perempuan/create', [DataKmsPerempuanController::class, 'create'])->name('data-kms-perempuan.create');
    ...
    Route::get('/bb-u-perempuan/create', [BbUPerempuanController::class, 'create'])->name('bb-u-perempuan.create');
    ...
    Route::get('/tb-u-perempuan/create', [TbUPerempuanController::class, 'create'])->name('tb-u-perempuan.create');
    ...
    Route::get('/bb-tb-perempuan/create', [BbTbPerempuanController::class, 'create'])->name('bb-tb-perempuan.create');
    ...
    Route::get('/lingkar-kepala-perempuan/create', [LingkarKepalaPerempuanController::class, 'create'])->name('lingkar-kepala-perempuan.create');
    ...
    Route::get('/kms-laki/create', [KmsLakiController::class, 'create'])->name('kms-laki.create');
    ...
    Route::get('/data-kms-laki/create', [DataKmsLakiController::class, 'create'])->name('data-kms-laki.create');
    ...
    Route::get('/bb-u-laki/create', [BbULakiController::class, 'create'])->name('bb-u-laki.create');
    ...
    Route::get('/tb-u-laki/create', [TbULakiController::class, 'create'])->name('tb-u-laki.create');
    ...
    Route::get('/bb-tb-laki/create', [BbTbLakiController::class, 'create'])->name('bb-tb-laki.create');
    ...
    Route::get('/lingkar-kepala-laki/create', [LingkarKepalaLakiController::class, 'create'])->name('lingkar-kepala-laki.create');
    ...
    Route::get('/imt-perempuan/create', [ImtPerempuanController::class, 'create'])->name('imt-perempuan.create');
    ...
    Route::get('/imt-laki/create', [ImtLakiController::class, 'create'])->name('imt-laki.create');
    ...
    Route::get('/kesehatan-gigi/create', [KesehatanGigiController::class, 'create'])->name('kesehatan-gigi.create');
    ...
    Route::get('/data-kesehatan-gigi/create', [DataKesehatanGigiController::class, 'create'])->name('data-kesehatan-gigi.create');
    ...
    Route::get('/ringkasan-mtbs/create', [RingkasanMtbsController::class, 'create'])->name('ringkasan-mtbs.create');
    ...
    Route::get('/ringkasan-pelayanan-dokter/create', [RingkasanPelayananDokterController::class, 'create'])->name('ringkasan-pelayanan-dokter.create');
    ...
    Route::get('/rujukan-anak/create', [RujukanAnakController::class, 'create'])->name('rujukan-anak.create');
