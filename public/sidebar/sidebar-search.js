...
const performSidebarSearch = function () {
    ...
    menuItems.forEach(item => {
        ...
        if (menuTextEl) {
            restoreOriginalText(menuTextEl); // selalu restore
            if (keyword) highlightMatches(menuTextEl, keyword); // lalu highlight ulang
        }
        ...
        if (submenu) {
            ...
            submenuItems.forEach(sub => {
                ...
                restoreOriginalText(subTextEl); // restore sebelum highlight
                if (keyword) highlightMatches(subTextEl, keyword);
