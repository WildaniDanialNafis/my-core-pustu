...
function loadGrafikBbTbLk() {
    const csrfToken = getCsrfToken();

    return fetch('/ajax/data-grafik-bb-tb-lk', {
        method: 'GET',
        headers: {
        ...
        .then(() => renderGrafikBbTbLk(csrfToken))
        .catch(error => {
            console.error('Error:', error);
        });
}

function renderGrafikBbTbLk(csrfToken) {
