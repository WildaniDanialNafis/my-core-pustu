...
function loadGrafikTbULk() {
    const csrfToken = getCsrfToken();

    return fetch('/ajax/data-grafik-tb-u-lk', {
        method: 'GET',
        headers: {
        ...
        .then(() => renderGrafikTbULk(csrfToken))
        .catch(error => {
            console.error('Error:', error);
        });
}

function renderGrafikTbULk(csrfToken) {
