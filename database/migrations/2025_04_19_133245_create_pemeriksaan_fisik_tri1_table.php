...
return new class extends Migration
{
    ...
    {
        Schema::create('pemeriksaan_fisik_tri1', function (Blueprint $table) {
            $table->id('id_pemeriksaan_fisik_tri1');
            $table->foreignId('id_pemeriksaan_trimester1')->constrained('pemeriksaan_trimester1', 'id_pemeriksaan_trimester1')->onDelete('cascade');
            $table->string('keadaan_umum',255)->nullable();
    ...
    {
        Schema::dropIfExists('pemeriksaan_fisik_tri1');
    }
};
