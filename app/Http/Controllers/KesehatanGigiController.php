...
class KesehatanGigiController extends Controller
{
    ...
    {
        $columns = Schema::getColumnListing('kesehatan_gigi');

        $data = DataTables::of(KesehatanGigi::query()->orderBy('id_kesehatan_gigi', 'desc'))->make(true);
    ...
    public function store(Request $request)
    {
        ...
        KesehatanGigi::create($validated);

        return redirect()->route('kesehatan-gigi.index')->with('success', 'Data ibu berhasil ditambahkan!');
    }
    ...
    {
        $data = KesehatanGigi::findOrFail($id);
        $columns = Schema::getColumnListing('kesehatan_gigi');
        return response()->json([
            'data' => $data,
            'columns' => $columns
    ...
    public function update(Request $request, string $id)
    {
        ...
        $newData = KesehatanGigi::findOrFail($id);
