...
class NasihatAnakController extends Controller
{
    /**
    ...
    {
        $columns = Schema::getColumnListing('nasihat_anak');

        $data = DataTables::of(NasihatAnak::query()->orderBy('id_nasihat_anak', 'desc'))->make(true);
    ...
    public function store(Request $request)
    {
        ...
        NasihatAnak::create($validated);

        return redirect()->route('nasihat-anak.index')->with('success', 'Data ibu berhasil ditambahkan!');
    }
    ...
    {
        $data = NasihatAnak::findOrFail($id);
        $columns = Schema::getColumnListing('nasihat_anak');
        return response()->json([
            'data' => $data,
            'columns' => $columns
    ...
    public function update(Request $request, string $id)
    {
        ...
        $newData = NasihatAnak::findOrFail($id);
