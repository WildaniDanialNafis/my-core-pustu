...
class TbUPerempuanController extends Controller
{
    ...
    {
        $columns = Schema::getColumnListing('tb_u_perempuan');

        $data = DataTables::of(TbUPerempuan::query()->orderBy('id_tb_u_perempuan', 'desc'))->make(true);
    ...
    public function store(Request $request)
    {
        ...
        TbUPerempuan::create($validated);

        return redirect()->route('tb-u-perempuan.index')->with('success', 'Data ibu berhasil ditambahkan!');
    }
    ...
    {
        $data = TbUPerempuan::findOrFail($id);
        $columns = Schema::getColumnListing('tb_u_perempuan');
        return response()->json([
            'data' => $data,
            'columns' => $columns
    ...
    public function update(Request $request, string $id)
    {
        ...
        $newData = TbUPerempuan::findOrFail($id);
