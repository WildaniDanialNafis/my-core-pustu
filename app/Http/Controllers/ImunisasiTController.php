...
class ImunisasiTController extends Controller
{
    /**
    ...
    {       
        $columns = Schema::getColumnListing('imunisasi_t');

        $data = DataTables::of(ImunisasiT::query()->orderBy('id_imunisasi_t', 'desc'))->make(true);
    ...
    public function store(Request $request)
    {
        ...
        ImunisasiT::create($validated);

        return redirect()->route('imunisasi-t.index')->with('success', 'Data ibu berhasil ditambahkan!');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $newData = ImunisasiT::findOrFail($id);
