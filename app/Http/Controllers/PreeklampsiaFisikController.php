...
class PreeklampsiaFisikController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $kesehatan = new PreeklampsiaFisik();
    ...
    {
        $columns = Schema::getColumnListing('preeklampsia_fisik');

        $data = DataTables::of(PreeklampsiaFisik::query()->orderBy('id_preeklampsia_fisik', 'desc'))->make(true);
    ...
    public function store(Request $request)
    {
        ...
        PreeklampsiaFisik::create($validated);

        return redirect()->route('preeklampsia-fisik.index')->with('success', 'Data ibu berhasil ditambahkan!');
    }
    ...
    {
        $data = PreeklampsiaFisik::findOrFail($id);
        $columns = Schema::getColumnListing('preeklampsia_fisik');
        return response()->json([
            'data' => $data,
            'columns' => $columns
    ...
    public function update(Request $request, string $id)
    {
        ...
        $newData = PreeklampsiaFisik::findOrFail($id);
