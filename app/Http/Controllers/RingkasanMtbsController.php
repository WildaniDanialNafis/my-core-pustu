...
class RingkasanMtbsController extends Controller
{
    /**
    ...
    {
        $columns = Schema::getColumnListing('ringkasan_mtbs');

        $data = DataTables::of(RingkasanMtbs::query()->orderBy('id_ringkasan_mtbs', 'desc'))->make(true);
    ...
    public function store(Request $request)
    {
        ...
        RingkasanMtbs::create($validated);

        return redirect()->route('ringkasan-mtbs.index')->with('success', 'Data ibu berhasil ditambahkan!');
    }
    ...
    {
        $data = RingkasanMtbs::findOrFail($id);
        $columns = Schema::getColumnListing('ringkasan_mtbs');
        return response()->json([
            'data' => $data,
            'columns' => $columns
    ...
    public function update(Request $request, string $id)
    {
        ...
        $newData = RingkasanMtbs::findOrFail($id);
