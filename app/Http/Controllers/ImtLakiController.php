...
class ImtLakiController extends Controller
{
    /**
    ...
    {
        $columns = Schema::getColumnListing('imt_laki');

        $data = DataTables::of(ImtLaki::query()->orderBy('id_imt_laki', 'desc'))->make(true);
    ...
    public function store(Request $request)
    {
        ...
        ImtLaki::create($validated);

        return redirect()->route('imt-laki.index')->with('success', 'Data ibu berhasil ditambahkan!');
    }
