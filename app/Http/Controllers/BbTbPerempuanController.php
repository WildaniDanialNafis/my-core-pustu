...
class BbTbPerempuanController extends Controller
{
    /**
    ...
    {
        $columns = Schema::getColumnListing('bb_tb_perempuan');

        $data = DataTables::of(BbTbPerempuan::query()->orderBy('id_bb_tb_perempuan', 'desc'))->make(true);
    ...
    public function store(Request $request)
    {
        ...
        BbTbPerempuan::create($validated);

        return redirect()->route('bb-tb-perempuan.index')->with('success', 'Data ibu berhasil ditambahkan!');
    }
    ...
    {
        $data = BbTbPerempuan::findOrFail($id);
        $columns = Schema::getColumnListing('bb_tb_perempuan');
        return response()->json([
            'data' => $data,
            'columns' => $columns
    ...
    public function update(Request $request, string $id)
    {
        ...
        $newData = BbTbPerempuan::findOrFail($id);
