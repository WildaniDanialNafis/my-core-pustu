...
class KN1Controller extends Controller
{
    /**
    ...
    {
        $columns = Schema::getColumnListing('kn1');

        $data = DataTables::of(KN1::query()->orderBy('id_kn1', 'desc'))->make(true);
    ...
    public function store(Request $request)
    {
        ...
        KN1::create($validated);

        return redirect()->route('kn1.index')->with('success', 'Data ibu berhasil ditambahkan!');
    }
