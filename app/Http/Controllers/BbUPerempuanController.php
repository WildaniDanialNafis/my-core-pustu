...
class BbUPerempuanController extends Controller
{
    ...
    {
        $columns = Schema::getColumnListing('bb_u_perempuan');

        $data = DataTables::of(BbUPerempuan::query()->orderBy('id_bb_u_perempuan', 'desc'))->make(true);
    ...
    public function store(Request $request)
    {
        ...
        BbUPerempuan::create($validated);

        return redirect()->route('bb-u-perempuan.index')->with('success', 'Data ibu berhasil ditambahkan!');
    }
    ...
    {
        $data = BbUPerempuan::findOrFail($id);
        $columns = Schema::getColumnListing('bb_u_perempuan');
        return response()->json([
            'data' => $data,
            'columns' => $columns
    ...
    public function update(Request $request, string $id)
    {
        ...
        $newData = BbUPerempuan::findOrFail($id);
